...
A lot of physics problems can be uniformly studied under the framework introduced in the previous chapters. However, for a specific problem, there are still many factors need to be considered. In this chapter, we give a detailed description of two specific problems: parachute simulation and entrainment-mixing simulation. The specific mathematical models as well as the implementations will be introduced in this chapter.
